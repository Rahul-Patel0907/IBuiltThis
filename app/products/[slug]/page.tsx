...
import { ArrowLeftIcon, StarIcon, CalendarIcon, UserIcon, ExternalLinkIcon } from "lucide-react";
                        ...
                        <div className="sticky top-24 space-y-4">
                            <div className="border rounded-lg p-6 bg-background">
                                <div className="text-center mb-6">
                                    ...
                                    <VotingButton hasVoted={false} voteCount={product.voteCount} productId={product.id} />
                                </div>
                                {
                                    voteCount > 100 && (
                                        <div className="pt-6">
                            ...
                            {websiteUrl && (<Button asChild className="w-full rounded-lg" variant={"outline"}>
                                <a href={websiteUrl} target="_blank" rel="noopener noreferrer">Visit Website <ExternalLinkIcon className="size-4 ml-2" /></a></Button>)}
                        </div>
                    </div>
